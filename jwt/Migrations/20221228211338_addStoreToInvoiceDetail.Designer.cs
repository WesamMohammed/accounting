...
namespace jwt.Migrations
{
    ...
    [Migration("20221228211338_addStoreToInvoiceDetail")]
    partial class addStoreToInvoiceDetail
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("jwt.Entities.InvoiceMaster", b =>
                {
                    ...
                    b.Property<int?>("AccountingMasterId")
                        .HasColumnType("int");
                    ...
                    b.HasIndex("AccountingMasterId")
                        .IsUnique()
                        .HasFilter("[AccountingMasterId] IS NOT NULL");
            ...
            modelBuilder.Entity("jwt.Entities.InvoiceMaster", b =>
                {
                    ...
                    b.HasOne("jwt.Entities.AccountingMaster", "AccountingMaster")
                        .WithOne("InvoiceMaster")
                        .HasForeignKey("jwt.Entities.InvoiceMaster", "AccountingMasterId");
